var msg_box = document.getElementById("msg_box"),
  button = document.getElementById("button_record"),
  canvas = document.getElementById("canvas"),
  lang = {
    mic_error: "اجازه دسترسی به میکروفن داده نشده است", //Ошибка доступа к микрофону
    press_to_start: "ضبط صدا", //Нажмите для начала записи
    recording: "در حال ضبط...", //Запись
    play: "پخش صدا", //Воспроизвести
    stop: "توقف پخش", //Остановить
